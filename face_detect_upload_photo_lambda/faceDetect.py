...
def handler(event, context):
    ...
    print("name : " + name + " shareGroupId : " + str(shareGroupId))
    #이미지 로드
    ...
    for i in range(normalized_vector.shape[0]):
        esQuery.elasticSearchApi(shareGroupId,name, normalized_vector[i], memberIdList)
    print("elasticsearch 전송 완료")
